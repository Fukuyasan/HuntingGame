...
/* Calculate the collision penalty for a given m_velocity vector
 * 
 * @param vcand sampled m_velocity
 * @param dvel desired m_velocity
											  ...
											  dtObstacleAvoidanceDebugData* debug)
{
	...
	for (int i = 0; i < m_nsegments; ++i)
	{
		...
		if (seg->touch)
		{
			...
			snorm[0] = -sdir[2];
			snorm[2] = sdir[0];
			// If the m_velocity is pointing towards the segment, no collision.
													 ...
													 dtObstacleAvoidanceDebugData* debug)
{
	...
	// Build sampling pattern aligned to desired m_velocity.
